  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg space-y-6">
        ...
        <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Image d'illustration</label>
            <div className="border border-gray-300 rounded-md p-4 bg-slate-50">
                <div className="w-full h-48 mb-4 bg-slate-200 rounded-md flex items-center justify-center overflow-hidden">
                    {image ? (
                 ...
                 <div>
                    <label htmlFor="image-upload" className="w-full cursor-pointer inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-secondary hover:bg-slate-700">
                    ...
                    <p className="text-xs text-gray-500 mt-2">PNG, JPG, WEBP. Max 2Mo.</p>
                 </div>
            </div>
        </div>
