...
const mockUsers: User[] = [
    { id: '1', name: 'Alice', avatar: 'https://picsum.photos/seed/alice/40/40', role: 'user' },
    { id: '2', name: 'Bob (Admin)', avatar: 'https://picsum.photos/seed/bob/40/40', role: 'admin' },
];

export const Header: React.FC<HeaderProps> = ({ currentUser, onLogin, onLogout, setView }) => {
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              {currentUser ? (
                ...
                <button
                  onClick={() => setDropdownOpen(!isDropdownOpen)}
                  className="px-4 py-2 border border-secondary text-sm font-medium rounded-md text-secondary hover:bg-slate-100 transition-colors"
                >
                  Se connecter
                </button>
              )}
