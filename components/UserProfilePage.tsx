        ...
        <div className="p-8">
            <div className="md:flex md:items-center md:gap-8">
                ...
                <div className="md:w-2/3">
                    <h2 className="text-3xl font-bold text-gray-800 dark:text-slate-100">{user.name}</h2>
                    <p className="text-gray-500 mt-1 dark:text-slate-400">{user.role === 'admin' ? 'Administrateur' : 'Membre'}</p>
            ...
            <div className="mt-8 border-t pt-6 dark:border-slate-700">
                 <h3 className="text-lg font-semibold text-gray-700 mb-2 dark:text-slate-300">Hobbies</h3>
                 <p className="text-gray-600 dark:text-slate-400">{user.hobbies || 'Non spécifié'}</p>
            </div>
        </div>
      </div>
    </div>
